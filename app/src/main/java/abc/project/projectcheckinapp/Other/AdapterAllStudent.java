...
public class AdapterAllStudent extends RecyclerView.Adapter<AdapterAllStudent.ViewHolder>{
    ...
    public AdapterAllStudent() {
    }

    public AdapterAllStudent(SQLiteDatabase db, ClickListener click, int cid) {
        this.db = db;
        this.click = click;
        this.cid = cid;
