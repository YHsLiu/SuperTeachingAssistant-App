...
public class AdapterNoRollCallStudent extends RecyclerView.Adapter<AdapterNoRollCallStudent.ViewHolder>{
    ...
    public AdapterNoRollCallStudent() {
    }

    public AdapterNoRollCallStudent(SQLiteDatabase db, ClickListener click, int cid) {
        this.db = db;
        this.click = click;
        this.cid = cid;
