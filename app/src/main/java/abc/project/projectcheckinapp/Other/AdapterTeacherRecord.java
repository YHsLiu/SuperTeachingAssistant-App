...
public class AdapterTeacherRecord extends RecyclerView.Adapter<AdapterTeacherRecord.ViewHolder>{
    ...
    public AdapterTeacherRecord(SQLiteDatabase db, int cid) {  // 學期紀錄
        this.db = db;
        this.cid = cid;
    ...
    public AdapterTeacherRecord(SQLiteDatabase db, String dateR, int cid) {  // 今日紀錄
        this.db = db;
        this.dateR = dateR;
        this.cid = cid;
        result = new ArrayList<>();
    ...
    public AdapterTeacherRecord(SQLiteDatabase db, int cid, int sid) {
        this.db = db;
        this.cid = cid;
        this.sid = sid;
        result = new ArrayList<>();
